...
│       ├── use-workplace-queries.ts
│       ├── use-contract-queries.ts
│       ├── use-attendance-queries.ts
│       ├── use-profile-queries.ts
│       ├── use-account-queries.ts
│       ├── use-career-queries.ts
│       ├── use-certificate-queries.ts
│       ├── use-document-queries.ts
│       ├── use-home-queries.ts
│       └── index.ts
├── providers/              # React Provider (QueryProvider 등)
├── lib/                    # API 클라이언트, query-client 등
├── store/                  # Zustand 스토어
