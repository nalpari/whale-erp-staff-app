...
export default function BottomSheetController() {
  ...
  useEffect(() => {
    // body 클래스 토글
    if (storeSheet || bankSelectSheet || accountSelectSheet || employmentNotificationSheet || commuteDaySelectSheet || avatarSelectSheet || phoneChangeSheet || personalAddSheet || certificateAddSheet || accountAddSheet || documentAddSheet) {
  ...
  }, [storeSheet, bankSelectSheet, accountSelectSheet, employmentNotificationSheet, commuteDaySelectSheet, avatarSelectSheet, phoneChangeSheet, personalAddSheet, certificateAddSheet, accountAddSheet, documentAddSheet])
